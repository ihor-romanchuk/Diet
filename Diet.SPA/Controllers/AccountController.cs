...
namespace Diet.SPA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<JwtDto> Login([FromBody] LoginDto model)
        {
            ...
            if (result.Succeeded)
            {
                ApplicationUserEntity appUser = _userManager.Users.SingleOrDefault(r => r.Email == model.Email);
                return await GenerateJwtAsync(appUser);
            }
        ...
        private async Task<JwtDto> GenerateJwtAsync(ApplicationUserEntity user)
        {
        ...
        //    if (result.Succeeded)
        //    {
        //        // UpdateAsync any authentication tokens if login succeeded
        ...
        //                // UpdateAsync any authentication tokens as well
        //                await _signInManager.UpdateExternalAuthenticationTokensAsync(info);
        ...
        private Task<ApplicationUserEntity> GetCurrentUserAsync()
        {
